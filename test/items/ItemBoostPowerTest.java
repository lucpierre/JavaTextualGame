 ...
 * @author lucqu
 */
public class ItemBoostPowerTest {
    
    private ItemBoostPower item;
    private Fighter fighter;
    private Place place;
    
    @Before
    public void setUp() {
        item = new ItemBoostPower("itemName", "itemDescription", 5);
    ...
    public void testEquip(){
        item.equip(fighter);
        assertSame(fighter.getPower(),15);
    }
    
    @Test
    public void testUnequip(){
        item.unequip(fighter);
        assertSame(fighter.getPower(), 5);
    }
}
